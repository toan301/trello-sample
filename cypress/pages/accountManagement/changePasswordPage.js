...
export class ChangePasswordPage extends AccountDashboardPage{
    // CSS
    ...
    validateElementsOnPage(){
        let elements = [this.txt_Current_Password, this.txt_New_Password, this.txt_New_Password_Confirm]
